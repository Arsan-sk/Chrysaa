...
export const sampleWorks: SampleWork[] = [
  {
    ...
    description:
      "Bespoke resin artworks presented through high-resolution spatial gallery curation with automated AI inquiry routing.",
  ...
  },
  {
    ...
    description:
      "Luxury venue portfolio with interactive floorplans, visual tours, booking calendar synchronization, and quote generation.",
  ...
  },
  {
    ...
    description:
      "Modern dining menu system with instant digital ordering, allergen filtering, live kitchen sync, and table QR routing.",
  ...
  },
  {
    ...
    description:
      "Inventory control and stock velocity dashboard with automated reorder triggers, dispatch tracking, and ledger feeds.",
  ...
  },
  {
    ...
    description:
      "Personalized gift recommendation engine driven by semantic search, visual personalization, and automated social campaigns.",
